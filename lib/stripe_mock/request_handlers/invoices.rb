  ...
  module RequestHandlers
    module Invoices
      ...
      def upcoming_invoice(route, method_url, params, headers)
        ...
        if prorating
          unused_amount = subscription[:plan][:amount].to_f * subscription[:quantity] * (subscription[:current_period_end] - subscription_proration_date.to_i) / (subscription[:current_period_end] - subscription[:current_period_start])
